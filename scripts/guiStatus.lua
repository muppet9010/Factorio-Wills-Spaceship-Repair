...
function GuiStatus.CreateStatusGui(player)
    ...
    GuiUtil.AddElement({parent = statusTable, name = "wages_value", type = "label", caption = "", tooltip = {"wills_spaceship_repair-wages-label"}, style = "muppet_bold_text"}, "GuiStatus")
    GuiUtil.AddElement({parent = statusTable, name = "dividends", type = "label", caption = "self", tooltip = "self", style = "muppet_bold_text"})
    GuiUtil.AddElement({parent = statusTable, name = "dividends_value", type = "label", caption = "", tooltip = {"wills_spaceship_repair-dividends"}, style = "muppet_bold_text"}, "GuiStatus")
    ...
    GuiUtil.AddElement({parent = statusTable, name = "profit_value", type = "label", caption = "", tooltip = {"wills_spaceship_repair-profit-label"}, style = "muppet_large_bold_text"}, "GuiStatus")
    ...
    GuiUtil.AddElement({parent = statusTable, name = "workforce_recruited_value", type = "label", caption = "", tooltip = {"wills_spaceship_repair-workforce_recruited"}, style = "muppet_large_bold_text"}, "GuiStatus")
...
function GuiStatus.CalculateStatusElementValues()
    local totalDebtValue = math.floor(global.Financials.wagesTotal - global.Financials.wagesPaid) + (global.Investments.investorsTotal - global.Investments.investorsPaid)
    local guiValues = {}
    ...
    guiValues.investorsPaid = Utils.DisplayNumberPretty(math.floor(global.Investments.investorsPaid))
    guiValues.investorsTotal = Utils.DisplayNumberPretty(math.floor(global.Investments.investorsTotal))
...
function GuiStatus.UpdateStatusElements(player, guiValues)
    ...
    GuiUtil.UpdateElementFromPlayersReferenceStorage(playerIndex, "GuiStatus", "dividends_value", "label", {caption = {"self", guiValues.investorsPaid, guiValues.investorsTotal}})
